...
int main()
{
  ...
  // the letter gets moved one from letter c to d
  char my_char2 = 'C';
  my_char2 = my_char2 + 1;
  ...
  // longer alphabetic
  // since z is the last letter we increased the value from a letter to a symbol
  char my_char3 = 'z';
  my_char3 = my_char3 + 1 ;
  ...
  // versus hexadecimal
  //my_short2 becomes negative because it overflows but int does not
